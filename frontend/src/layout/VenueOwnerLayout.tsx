  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex h-screen">
        {/* Sidebar */}
        <div
          className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform transition-transform lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
        >
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-lg text-gray-400 hover:bg-gray-100 cursor-pointer"
            >
            ...
            {menuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`cursor-pointer w-full flex items-center gap-3 px-3 py-2 rounded-4xl transition-all ${
                    isActive
                ...
                >
                  ...
                  {item.badge && (
                    <span
                      className={`ml-auto px-2 py-1 text-xs rounded-full ${isActive ? "bg-white text-primary" : "bg-red-500 text-white"}`}
                    >
                      {item.badge}
                    </span>
                  )}
