...
import { FETCH_MATCHES_ACTION, REQUEST_TO_JOIN_ACTION } from '@/redux/actions/player/matchmaking.actions'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">Discover and join matches with other players</p>
        </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          <span className={`px-3 py-1 text-xs font-medium rounded-full ${getSkillLevelColor(match.skillLevel)}`}>
                            {match.skillLevel}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-gray-600">by {match.creator.name}</span>
                        </div>
