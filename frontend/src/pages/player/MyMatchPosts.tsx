...
import { FETCH_MY_MATCHES_ACTION, DELETE_MATCH_ACTION } from '@/redux/actions/player/matchmaking.actions'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">You haven't created any matches yet</p>
            <button
          ...
          <div className="space-y-4">
            {myMatches.map((match: MatchPost) => {
              ...
              return (
                <div key={match.matchId} className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex-1">
                      ...
                      {match.requests && match.requests.length > 0 && (
                        <div className="mb-4 p-3 bg-blue-50 rounded-lg">
                          <p className="text-sm font-medium text-blue-900">
                            {match.requests.filter(r => r.status === 'PENDING').length} pending request(s)
                          </p>
                        </div>
                      )}
                      ...
                      <div className="flex gap-2">
                        ...
                        {canAccessChat(match) && (
                          <button
                            onClick={() => navigate(`/player/matches/${match.matchId}/chat`)}
        ...
        <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                This action cannot be undone. This will permanently delete the match "{selectedMatch?.title}".
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <button
