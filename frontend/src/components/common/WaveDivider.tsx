      ...
      >
        <defs>
          <linearGradient id="waveGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="100%" stopColor="#72D2F0" stopOpacity={opacity} />
            <stop offset="33%" stopColor="#A1E4F6" stopOpacity={opacity} />
            <stop offset="66%" stopColor="#A7E5F5" stopOpacity={opacity} />
            <stop offset="100%" stopColor="#DFF5FB" stopOpacity={opacity} />
          </linearGradient>
        </defs>
